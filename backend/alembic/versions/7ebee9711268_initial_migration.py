...
def upgrade() -> None:
    ...
    op.create_geospatial_table('puntos_control',
    ...
    op.create_geospatial_index('idx_puntos_control_ubicacion', 'puntos_control', ['ubicacion'], unique=False, postgresql_using='gist', postgresql_ops={})
    op.create_geospatial_table('recorrido',
    ...
    op.create_geospatial_index('idx_recorrido_line', 'recorrido', ['line'], unique=False, postgresql_using='gist', postgresql_ops={})
    op.create_geospatial_index('idx_recorrido_ubicacion', 'recorrido', ['ubicacion'], unique=False, postgresql_using='gist', postgresql_ops={})
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_geospatial_index('idx_recorrido_ubicacion', table_name='recorrido', postgresql_using='gist', column_name='ubicacion')
    op.drop_geospatial_index('idx_recorrido_line', table_name='recorrido', postgresql_using='gist', column_name='line')
    op.drop_geospatial_table('recorrido')
    op.drop_geospatial_index('idx_puntos_control_ubicacion', table_name='puntos_control', postgresql_using='gist', column_name='ubicacion')
    op.drop_geospatial_table('puntos_control')

    ...
    <View style={styles.floatingCard}>
      <View style={styles.routesContainer}>
          ...
          {rutasData.map((item: any) => (
            ...
            >
              <Text
                style={[
                  styles.chipText,
                  lineaSeleccionada.linea === item.linea && styles.chipTextActive,
                ]}
              >
                {item.linea}
              </Text>
        ...
        <View style={styles.sentidoRow}>
          <TouchableOpacity
            style={[styles.sentidoBtn, esIda ? styles.btnIda : styles.btnInactive]}
          ...
          <TouchableOpacity
            style={[styles.sentidoBtn, !esIda ? styles.btnVuelta : styles.btnInactive]}
